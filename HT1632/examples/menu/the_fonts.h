...
unsigned char D[8]={0x81,0xff,0xff,129,0x81,0x81,0x7e,0x00};
unsigned char E[8]={0x00,0x7e,0xff,0x99,0x99,0x99,0x81,0x00};
unsigned char F[8]={0x00,0xff,0xff,0x19,0x19,0x19,0x01,0x00};
unsigned char G[8]={0x00,0x7e,0xff,0x81,0x81,0x91,113,0x00};
unsigned char H[8]={0x00,0xff,0xff,0x18,0x18,0xff,0xff,0x00};
...
unsigned char *mes="    mamadou va a l ecole avec bineta , apres un bon cafe au lait ! ils aiment bien les etudes , les maths etc  yeeeees !!!!!!      ";
